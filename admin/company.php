...
<body>
	<div class="container">
	<button style="position: fixed; top: 10px; left: 75px; background-color: #131E3A; color: white; margin-top: 10px; margin-left: 10px;" onclick="window.history.back();">Go Back</button>
		...
		<table class="table table-striped table-hover">
            ...
            <tr>
				...
				if(mysqli_num_rows($result)>0){
					...
					<td>
						<a href = "update.php?id=<?= $row["id"]; ?>" class="btn btn-dark">Update</a>

					</td>
					<td>
					<a href = "deletecompany.php?id=<?= $row["id"]; ?>" class="btn btn-danger">Delete</a>
